...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition hover:scale-105"
      style={{ background: "linear-gradient(135deg, #ffe9a8, #f6c34b 45%, #d99323 80%, #b5651d)" }}
    >
      <svg width="28" height="28" viewBox="0 0 24 24" fill="#0a0705" aria-hidden="true">
