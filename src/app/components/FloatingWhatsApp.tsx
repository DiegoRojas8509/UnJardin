...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-olive text-cream-light shadow-lg transition hover:scale-105 hover:bg-olive-dark"
    >
